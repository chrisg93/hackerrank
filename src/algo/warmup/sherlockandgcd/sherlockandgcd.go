...
// Sherlock is stuck. He has an array A1,A2,⋯,AN. He wants to know if there exists a subset,
// B={Ai1,Ai2,…,Aik} where 1≤i1<i2<…<ik≤N, of this array which follows the property
